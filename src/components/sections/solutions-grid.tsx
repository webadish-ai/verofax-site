          ...
          {SOLUTIONS.map((s) => (
            <RevealItem key={s.slug}>
              <SpotlightCard
                ...
                className="group relative isolate flex h-full flex-col overflow-hidden rounded-3xl border border-line bg-white p-7 shadow-card transition-all duration-300 hover:-translate-y-1 hover:border-brand-400 hover:shadow-glow"
              >
                <div className="relative z-10 flex h-full flex-col">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-500 to-cyan-400 text-white shadow-[0_8px_20px_-6px_rgba(46,125,242,0.6)] transition-transform duration-300 group-hover:-rotate-6 group-hover:scale-110">
